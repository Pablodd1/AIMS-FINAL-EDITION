...
import MedicalScribe from "@/pages/medical-scribe";
import MedicalCodesManager from "@/pages/medical-codes-manager";
import PatientImport from "@/pages/patient-import";
import PatientPortal from "@/pages/patient-portal";
import AuditLogsViewer from "@/pages/admin/audit-logs";
...
function Router() {
  return (
    <Switch>
      ...
      <ProtectedRoute path="/medical-scribe" component={MedicalScribePage} />
      <ProtectedRoute path="/medical-codes" component={MedicalCodesPage} />
      <ProtectedRoute path="/patients/import" component={PatientImportPage} />
      <ProtectedRoute path="/patient-portal" component={PatientPortalPage} />
      <ProtectedRoute path="/admin/audit-logs" component={AuditLogsPage} />
