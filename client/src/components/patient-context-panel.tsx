        ...
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-lg">{t('patientContext.title')}</CardTitle>
            </div>
            <div className="flex items-center gap-2">
              <Button 
                variant="outline" 
                ...
                {patientContext.activeMedications.length > 0 && (
                  <div>
                    <h4 className="font-medium text-sm flex items-center gap-2 mb-2">
                      ...
                      {t('patientContext.medications')} ({patientContext.activeMedications.length})
                    </h4>
                ...
                {patientContext.medicalHistory && (
                  <div>
                    <h4 className="font-medium text-sm flex items-center gap-2 mb-2">
                      ...
                      {t('patientContext.medicalHistory')}
                    </h4>
                ...
                {patientContext.recentNotes.length > 0 && (
                  <div>
                    <h4 className="font-medium text-sm flex items-center gap-2 mb-2">
                      ...
                      {t('patientContext.recentNotes')} ({patientContext.recentNotes.length})
                    </h4>
                ...
                {patientContext.recentActivity.length > 0 && (
                  <div>
                    <h4 className="font-medium text-sm flex items-center gap-2 mb-2">
                      ...
                      {t('patientContext.recentActivity')}
                    </h4>
                    <div className="space-y-1">
                ...
                {!patientContext.lastVisit && 
                 ...
                 patientContext.activeAlerts.length === 0 && (
                  <div className="text-center text-muted-foreground py-4">
                    ...
                    <p className="text-sm">{t('patientContext.noHistory')}</p>
                    <p className="text-xs">{t('patientContext.newPatient')}</p>
                  </div>
                )}
              </div>
            </ScrollArea>
