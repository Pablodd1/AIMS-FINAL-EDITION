    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="w-64 bg-secondary/10 border-r border-border p-3 flex flex-col h-full">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-lg font-semibold">{t('assistant.history')}</h2>
          <TooltipProvider>
            <Tooltip>
        ...
        <div className="mt-2 pt-2 border-t border-border">
          <p className="text-xs text-muted-foreground">{language === 'es' ? 'Conectado como' : 'Logged in as'} {user?.username || 'User'}</p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col h-full">
        ...
        <div className="p-4 border-b border-border flex items-center justify-between">
          <div>
            <h1 className="text-lg font-semibold">{activeSession?.title || t('assistant.new')}</h1>
                ...
                <div className={`rounded-lg p-4 max-w-[80%] 
                  ...
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-medium">
                      {message.role === 'user' ? t('assistant.you') : 'Doctor Helper Smart'}
                    </span>
                  </div>
