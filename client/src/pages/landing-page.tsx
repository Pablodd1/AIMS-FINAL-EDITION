...
const FeatureBox = ({
  ...
  return (
    <div
      className={`flex flex-col h-full p-6 border rounded-lg ${colors[color]} transition-all`}
    >
      ...
      <p className="text-sm text-center text-gray-400 mb-6 flex-grow">
        {description}
      </p>
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex flex-col">
      ...
      <main className="flex-grow max-w-7xl mx-auto py-12 px-6 w-full">
        <div className="text-center mb-16 max-w-4xl mx-auto">
          <h3 className="text-4xl font-bold mb-2">
            Advanced Intelligent Medical Solutions
          </h3>
          <p className="text-xl text-gray-400">
            A comprehensive suite of AI-powered tools to enhance medical
            practice management, patient care, and clinical workflows
          </p>
        </div>
