...
`);
  ...
  // Register voice command callbacks for this page
  useEffect(() => {
    window.startRecording = handleStartConsultation;
    window.generateNotes = handleGenerateNotes;
    window.saveNotes = handleSaveNote;
    window.previewNotes = () => setShowPreview(true);
    window.downloadNotes = handleDownloadNote;
    window.clearForm = resetForm;

    return () => {
      window.startRecording = undefined;
      window.generateNotes = undefined;
      window.saveNotes = undefined;
      window.previewNotes = undefined;
      window.downloadNotes = undefined;
      window.clearForm = undefined;
    };
  }, [handleGenerateNotes, handleSaveNote, handleDownloadNote]);
