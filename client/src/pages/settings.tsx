    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="general" value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid grid-cols-3 w-full">
          <TabsTrigger value="general">{t('settings.tabEmail')}</TabsTrigger>
          <TabsTrigger value="templates">{t('settings.tabTemplates')}</TabsTrigger>
          <TabsTrigger value="api-key">{t('settings.tabApiKey')}</TabsTrigger>
        </TabsList>
              ...
              <Form {...emailSettingsForm}>
                <form onSubmit={emailSettingsForm.handleSubmit(onSubmitEmailSettings)} className="space-y-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t('settings.senderEmail')}</FormLabel>
                        <FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t('settings.senderName')}</FormLabel>
                        <FormControl>
                          <Input placeholder="Dr. John Smith's Office" {...field} />
                        </FormControl>
                        <FormDescription>
                          {t('settings.senderNameDesc')}
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t('settings.appPassword')}</FormLabel>
                        <FormControl>
                          <Input 
                  ...
                  <div className="flex space-x-2">
                    ...
                    >
                      {saveEmailSettingsMutation.isPending ? "Saving..." : t('settings.saveSettings')}
                    </Button>
                    <Button 
                      type="button" 
                      variant="outline" 
                    ...
                    >
                      {sendTestEmailMutation.isPending ? "Sending..." : t('settings.sendTest')}
                    </Button>
                  </div>
                </form>
              </Form>
              ...
              <Form {...emailTemplateForm}>
                <form onSubmit={emailTemplateForm.handleSubmit(onSubmitEmailTemplates)} className="space-y-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t('settings.confirmTemplate')}</FormLabel>
                        <FormControl>
                          <Textarea className="min-h-[120px]" {...field} />
                        </FormControl>
                        <FormDescription>
                          {t('settings.confirmTemplateDesc')}
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t('settings.reminderTemplate')}</FormLabel>
                        <FormControl>
                          <Textarea className="min-h-[120px]" {...field} />
                        </FormControl>
                        <FormDescription>
                          {t('settings.reminderTemplateDesc')}
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t('settings.cancelTemplate')}</FormLabel>
                        <FormControl>
                          <Textarea className="min-h-[120px]" {...field} />
                        </FormControl>
                        <FormDescription>
                          {t('settings.cancelTemplateDesc')}
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>{t('settings.rescheduleTemplate')}</FormLabel>
                        <FormControl>
                          <Textarea className="min-h-[120px]" {...field} />
                        </FormControl>
                        <FormDescription>
                          {t('settings.rescheduleTemplateDesc')}
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  >
                    {saveEmailTemplatesMutation.isPending ? "Saving..." : t('settings.saveTemplates')}
                  </Button>
                </form>
              </Form>
            </CardContent>
                  ...
                  <Form {...apiKeyForm}>
                    <form onSubmit={apiKeyForm.handleSubmit(onSubmitApiKey)} className="space-y-4">
                      ...
                      <div className="flex space-x-2">
                        ...
                        >
                          {saveApiKeyMutation.isPending ? "Saving..." : apiKeyData?.hasApiKey ? t('settings.updateApiKey') : t('settings.saveApiKey')}
                        </Button>
                        ...
                        {apiKeyData?.hasApiKey && (
                          ...
                          >
                            {deleteApiKeyMutation.isPending ? "Removing..." : t('settings.removeApiKey')}
                          </Button>
                        )}
                      </div>
                    </form>
