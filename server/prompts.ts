...
#############################################
# 2. EMBEDDED CLINIC PROTOCOLS (RAG)
#############################################
- **Diabetes Management:** Target HbA1c < 7.0% for most adults; consider GLP-1 RA for those with ASCVD.
- **Hypertension:** Goal < 130/80 mmHg per ACC/AHA guidelines.
- **Root Cause Analysis:** Always investigate "The why" (e.g., Is the chronic stress driving the cortisol and glucose?).
- **Lab Interpretation:** Use Functional Medicine optimal ranges (e.g., Ferritin 50-150 ng/mL, not just the broad 10-300 range).

#############################################
# 3. ZERO HALLUCINATION & SAFETY PROTOCOL
#############################################
